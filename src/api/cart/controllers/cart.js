...
//         const existingProducts = cart[0].products.map((p) => p.id);
...
//       return ctx.send({ message: 'Product added to cart successfully!' });
//     } catch (error) {
//       console.error(error);
//       return ctx.badRequest('Error adding product to cart', { error });
//     }
//   },
// };
module.exports = {
